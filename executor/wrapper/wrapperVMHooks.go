...
func (w *WrapperVMHooks) ManagedGetBackTransfers(dcdtTransfersValueHandle int32, callValueHandle int32) {
	callInfo := fmt.Sprintf("ManagedGetBackTransfers(%d, %d)", dcdtTransfersValueHandle, callValueHandle)
	w.logger.LogVMHookCallBefore(callInfo)
	w.wrappedVMHooks.ManagedGetBackTransfers(dcdtTransfersValueHandle, callValueHandle)
	w.logger.LogVMHookCallAfter(callInfo)
}
