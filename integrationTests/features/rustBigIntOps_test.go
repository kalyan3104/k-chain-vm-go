...
import (
	...
	mei "github.com/kalyan3104/k-chain-scenario-go/scenario/expression/interpreter"
...
func getFeaturesContractCode() []byte {
	...
	result, err := ei.InterpretString("ksc:test/features/basic-features/output/basic-features.ksc.json")
	if err != nil {
		panic(err)
	}
	return result
