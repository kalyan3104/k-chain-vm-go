...
import (
	...
	"github.com/kalyan3104/k-chain-vm-go/crypto"
	"github.com/kalyan3104/k-chain-vm-go/crypto/factory"
	"github.com/kalyan3104/k-chain-vm-go/executor"
	"github.com/kalyan3104/k-chain-vm-go/vmhost"
	"github.com/kalyan3104/k-chain-vm-go/vmhost/contexts"
...
// allFlags must have all flags used by k-chain-vm-go in the current version
var allFlags = []core.EnableEpochFlag{
	vmhost.MultiDCDTTransferFixOnCallBackFlag,
