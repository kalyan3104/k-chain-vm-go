...
typedef struct {
  ...
  int32_t (*get_dcdt_balance_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len, int64_t nonce, int32_t result_offset);
  int32_t (*get_dcdt_nft_name_length_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len, int64_t nonce);
  int32_t (*get_dcdt_nft_attribute_length_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len, int64_t nonce);
  int32_t (*get_dcdt_nft_uri_length_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len, int64_t nonce);
  int32_t (*get_dcdt_token_data_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len, int64_t nonce, int32_t value_handle, int32_t properties_offset, int32_t hash_offset, int32_t name_offset, int32_t attributes_offset, int32_t creator_offset, int32_t royalties_handle, int32_t uris_offset);
  int64_t (*get_dcdt_local_roles_func_ptr)(void *context, int32_t token_id_handle);
  ...
  int32_t (*transfer_dcdt_execute_func_ptr)(void *context, int32_t dest_offset, int32_t token_id_offset, int32_t token_id_len, int32_t value_offset, int64_t gas_limit, int32_t function_offset, int32_t function_length, int32_t num_arguments, int32_t arguments_length_offset, int32_t data_offset);
  int32_t (*transfer_dcdt_nft_execute_func_ptr)(void *context, int32_t dest_offset, int32_t token_id_offset, int32_t token_id_len, int32_t value_offset, int64_t nonce, int64_t gas_limit, int32_t function_offset, int32_t function_length, int32_t num_arguments, int32_t arguments_length_offset, int32_t data_offset);
  int32_t (*multi_transfer_dcdt_nft_execute_func_ptr)(void *context, int32_t dest_offset, int32_t num_token_transfers, int32_t token_transfers_args_length_offset, int32_t token_transfer_data_offset, int64_t gas_limit, int32_t function_offset, int32_t function_length, int32_t num_arguments, int32_t arguments_length_offset, int32_t data_offset);
  ...
  int32_t (*get_dcdt_value_func_ptr)(void *context, int32_t result_offset);
  int32_t (*get_dcdt_value_by_index_func_ptr)(void *context, int32_t result_offset, int32_t index);
  int32_t (*get_dcdt_token_name_func_ptr)(void *context, int32_t result_offset);
  int32_t (*get_dcdt_token_name_by_index_func_ptr)(void *context, int32_t result_offset, int32_t index);
  int64_t (*get_dcdt_token_nonce_func_ptr)(void *context);
  int64_t (*get_dcdt_token_nonce_by_index_func_ptr)(void *context, int32_t index);
  int64_t (*get_current_dcdt_nft_nonce_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len);
  int32_t (*get_dcdt_token_type_func_ptr)(void *context);
  int32_t (*get_dcdt_token_type_by_index_func_ptr)(void *context, int32_t index);
  int32_t (*get_num_dcdt_transfers_func_ptr)(void *context);
  ...
  int32_t (*managed_multi_transfer_dcdt_nft_execute_func_ptr)(void *context, int32_t dst_handle, int32_t token_transfers_handle, int64_t gas_limit, int32_t function_handle, int32_t arguments_handle);
  ...
  int32_t (*managed_is_dcdt_frozen_func_ptr)(void *context, int32_t address_handle, int32_t token_id_handle, int64_t nonce);
  int32_t (*managed_is_dcdt_limited_transfer_func_ptr)(void *context, int32_t token_id_handle);
  int32_t (*managed_is_dcdt_paused_func_ptr)(void *context, int32_t token_id_handle);
  ...
  void (*big_int_get_dcdt_call_value_func_ptr)(void *context, int32_t destination);
  void (*big_int_get_dcdt_call_value_by_index_func_ptr)(void *context, int32_t destination_handle, int32_t index);
  void (*big_int_get_external_balance_func_ptr)(void *context, int32_t address_offset, int32_t result);
  void (*big_int_get_dcdt_external_balance_func_ptr)(void *context, int32_t address_offset, int32_t token_id_offset, int32_t token_id_len, int64_t nonce, int32_t result_handle);
