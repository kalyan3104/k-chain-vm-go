...
// extern void      w2_managedGetBackTransfers(void* context, int32_t dcdtTransfersValueHandle, int32_t callValueHandle);
...
func w2_managedGetBackTransfers(context unsafe.Pointer, dcdtTransfersValueHandle int32, callValueHandle int32) {
	vmHooks := getVMHooksFromContextRawPtr(context)
